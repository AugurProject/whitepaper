...
Any REP tokens that have not been migrated out of the parent universe when 60 days have passed since a fork occurred will be permanently locked in the parent universe. Such tokens are expected to lose all value, so it is of paramount importance that REP holders migrate their tokens anytime a fork happens.
